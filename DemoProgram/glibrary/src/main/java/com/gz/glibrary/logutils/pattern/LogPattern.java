package com.gz.glibrary.logutils.pattern;

import com.gz.glibrary.logutils.utils.Utils;
...
public abstract class LogPattern {
  ...
  public static class PlainLogPattern extends LogPattern {
    ...
    @Override protected String doApply(StackTraceElement caller) {
      return string;
    }
  }
  ...
  public static class CallerLogPattern extends LogPattern {
    ...
    @Override protected boolean isCallerNeeded() {
      return true;
    }
  }
  ...
  public static class Compiler {
    ...
    public static final Pattern CALLER_PATTERN =
    ...
    public static final Pattern CALLER_PATTERN_SHORT =
