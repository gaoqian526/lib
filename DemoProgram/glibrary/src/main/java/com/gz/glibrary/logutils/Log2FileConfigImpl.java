...
import com.gz.glibrary.logutils.pattern.LogPattern;
import java.io.File;
...
class Log2FileConfigImpl implements Log2FileConfig {
  ...
  @LogLevel.LogLevelType private int logLevel = LogLevel.TYPE_VERBOSE;
  ...
  @Override public Log2FileConfig configLog2FileEnable(boolean enable) {
    this.enable = enable;
    return this;
  }
  ...
  @Override public Log2FileConfig configLog2FilePath(String logPath) {
  ...
  @Override public Log2FileConfig configLog2FileNameFormat(String formatName) {
  ...
  @Override public Log2FileConfig configLog2FileLevel(@LogLevel.LogLevelType int level) {
    this.logLevel = level;
    return this;
  }
  ...
  @Override public Log2FileConfig configLogFileEngine(LogFileEngine engine) {
    this.engine = engine;
    return this;
  }

  @Override public Log2FileConfig configLogFileFilter(LogFileFilter fileFilter) {
