...
public class MessageParse implements Parser<Message> {
  @Override public Class<Message> parseClassType() {
    return Message.class;
  }

  @Override public String parseString(Message message) {
    if (message == null) {
      return null;
    }
    ...
    stringBuilder.append(String.format("%s = %s", "data", new BundleParse().parseString(message.getData())))
