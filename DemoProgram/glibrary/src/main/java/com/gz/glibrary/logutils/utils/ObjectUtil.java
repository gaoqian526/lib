package com.gz.glibrary.logutils.utils;

import com.gz.glibrary.logutils.Constant;
import com.gz.glibrary.logutils.Parser;
import java.lang.reflect.Field;
import java.lang.reflect.Modifier;

import static com.gz.glibrary.logutils.Constant.BR;
      ...
      try {
        ...
        if (subObject != null) {
          ...
          boolean staticInnerClass =
              !isStaticInnerClass(cla) && (field.getName().equals("$change") || field.getName().equalsIgnoreCase("this$0"));
          if (staticInnerClass) {
            continue;
          }
